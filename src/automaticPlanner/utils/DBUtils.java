...
import automaticPlanner.beans.Instructor;
import automaticPlanner.beans.UserAccount;
     
    public class DBUtils {
        //for CS REQUIREMENTS page
        public static List<Courses> queryCS_courses(Connection conn) throws SQLException {
          String sql = "Select a.classType, a.classNumber, a.classTitle, "
    		+ "a.Credits from cs_requirements a ";
        ...
        public static List<Courses> queryCourses(Connection conn) throws SQLException {
          String sql = "Select a.idClass, a.classType, a.classNumber, "
    		+ "a.classTitle, a.Days, a.classStartTime, a.classEndTime from classes a ";
            ...
            while (rs.next()) {
                ...
                course.setClassStartTime(start);
                course.setClassEndTime(end);
        ...
        //for search page NOT USED
        public static List<Courses> findCourses(Connection conn, String id) throws SQLException {
            
            String sql = "Select a.idClass, a.classType, a.classNumber, "
            		+ "a.classTitle, a.Days, a.classStartTime, a.classEndTime from classes a where a.idClass=?";
        ...
        //for serach page, search by classNumber only
        public static List<Courses> findCourses1(Connection conn, String cNum) throws SQLException {
            
            String sql = "Select a.idClass, a.classType, a.classNumber, "
            		+ "a.classTitle, a.Days, a.classStartTime, a.classEndTime from classes a where a.classNumber=?";
        ...
        public static void coreRequirementCheck(List<Courses> list, HttpServletRequest request) {
    		...
    		boolean CSC2xx=false; //lower division elective
        	...
        	request.setAttribute("CSCElective", CSCElective);
        ...
        public static List<Courses> AutoPlannerVersion1(Connection conn, HttpServletRequest request, String studentID) throws SQLException {
        	...
        	while(x<6) {
        		...
        		if(a<=18) {
        			...
        			if(Suggestion.getClassTitle().equals("No more suggestions at this time") && Suggestions.isEmpty()){
        ...
        public static Courses addClassSuggestion(HttpServletRequest request) {
        	...
        	C.setClassTitle("No more suggestions at this time");
        	C.setCredits("0");
